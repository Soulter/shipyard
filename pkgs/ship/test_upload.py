    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            with open(temp_file_path, 'rb') as f:
                ...
                async with session.post(f"{base_url}/upload", data=data, headers=headers) as resp:
            ...
            with open(temp_file_path, 'rb') as f:
                data = aiohttp.FormData()
                data.add_field('file', f, filename='test2.txt', content_type='text/plain')
                data.add_field('file_path', f'/workspace/{session_id}/absolute/test2.txt')
            ...
            with open(temp_file_path, 'rb') as f:
                data = aiohttp.FormData()
                data.add_field('file', f, filename='test3.txt', content_type='text/plain')
            ...
            with open(temp_file_path, 'rb') as f:
                data = aiohttp.FormData()
                data.add_field('file', f, filename='test4.txt', content_type='text/plain')
